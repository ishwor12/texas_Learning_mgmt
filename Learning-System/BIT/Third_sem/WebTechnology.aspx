<%@ Page Title="" Language="C#" MasterPageFile="~/BIT/bit.Master" AutoEventWireup="true" CodeBehind="WebTechnology.aspx.cs" Inherits="Learning_System.BIT.Third_sem.WebTechnology" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
     <div class="container">
         <h3>WEB TECHNOLOGY LEARNING RESOURCES</h3>
        <hr />
