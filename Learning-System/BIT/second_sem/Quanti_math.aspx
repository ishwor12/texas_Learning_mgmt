<%@ Page Title="" Language="C#" MasterPageFile="~/BIT/bit.Master" AutoEventWireup="true" CodeBehind="Quanti_math.aspx.cs" Inherits="Learning_System.BIT.second_sem.Quanti_math" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
     <div class="container">
         <h3> QUANTATIVE METHOD LEARNING RESOURCES</h3>
        <hr />
