<%@ Page Title="" Language="C#" MasterPageFile="~/BIT/bit.Master" AutoEventWireup="true" CodeBehind="Operating_system.aspx.cs" Inherits="Learning_System.BIT.Third_sem.Operating_system" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
     <div class="container">
         <h3>DIGITAL LOGIC LEARNING RESOURCES</h3>
        <hr />
