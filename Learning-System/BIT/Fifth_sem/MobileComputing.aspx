<%@ Page Title="" Language="C#" MasterPageFile="~/BIT/bit.Master" AutoEventWireup="true" CodeBehind="MobileComputing.aspx.cs" Inherits="Learning_System.BIT.Fifth_sem.MobileComputing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container">
         <h3>MOBILE COMPUTING LEARNING RESOURCES</h3>
        <hr />
