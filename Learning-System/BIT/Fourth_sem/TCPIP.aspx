<%@ Page Title="" Language="C#" MasterPageFile="~/BIT/bit.Master" AutoEventWireup="true" CodeBehind="TCPIP.aspx.cs" Inherits="Learning_System.BIT.Fourth_sem.TCPIP" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
         <h3>TCP/IP LEARNING RESOURCES</h3>
        <hr />
