<%@ Page Title="" Language="C#" MasterPageFile="~/BIT/bit.Master" AutoEventWireup="true" CodeBehind="business_Eng.aspx.cs" Inherits="Learning_System.BIT.business_Eng" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
         <h3>Lecturer Notes of BUSINESS ENGLISH</h3>
        <hr />
