<%@ Page Title="" Language="C#" MasterPageFile="~/BIT/bit.Master" AutoEventWireup="true" CodeBehind="IndustrialTraining.aspx.cs" Inherits="Learning_System.BIT.Sixth_sem.IndustrialTraining" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container">
         <h3>FUNDAMENTAL OF ALGORITHM LEARNING RESOURCES</h3>
        <hr />
