<%@ Page Title="" Language="C#" MasterPageFile="~/upload_sec/upload.Master" AutoEventWireup="true" CodeBehind="c_programming.aspx.cs" Inherits="Learning_System.upload_sec.first_sem.c_programming" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
        ...
        <asp:Label ID="lblMessage" runat="server" ForeColor="#00CC00" />
        
   

   
       <div class="container">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" class="table table-bordered table-condensed table-responsive table-hover" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
            <Columns>
