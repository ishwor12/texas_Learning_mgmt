<%@ Page Title="" Language="C#" MasterPageFile="~/BIT/bit.Master" AutoEventWireup="true" CodeBehind="RDBMS.aspx.cs" Inherits="Learning_System.BIT.Fourth_sem.RDBMS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
         <h3>RDBMS LEARNING RESOURCES</h3>
        <hr />
