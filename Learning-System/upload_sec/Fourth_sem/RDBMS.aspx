<%@ Page Title="" Language="C#" MasterPageFile="~/upload_sec/upload.Master" AutoEventWireup="true" CodeBehind="RDBMS.aspx.cs" Inherits="Learning_System.upload_sec.Fourth_sem.RDBMS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; margin-top: 40px; margin-bottom:40px;">
     
        <h3 style="text-align: center">RELATIONAL DBMS</h3>
        <hr />
