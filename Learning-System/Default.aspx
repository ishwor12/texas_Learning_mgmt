...
<div class="card-deck">
  ...
  <div class="card" style="box-shadow: rgba(0, 0, 0, 0.2) 0px 20px 30px;">
    ...
    <li class="list-group-item">
        <asp:LinkButton ID="LinkBCS" runat="server" style="color:#124792; font-size:14px; width:100%; " OnClientClick="~/BIT/CALENDAR_BIT.aspx" >Acedemic Calender</asp:LinkButton></li>
  ...
  <div class="card" style="box-shadow: rgba(0, 0, 0, 0.2) 0px 20px 30px;">
    ...
    <ul class="list-group list-group-flush">
     ...
     <li class="list-group-item">Learning Resouces</li>
    <li class="list-group-item">
        <asp:LinkButton ID="LinkButton18" runat="server" style="color:#124792; font-size:14px; width:100%;" OnClick="LinkButton18_Click">Acedemic Calender</asp:LinkButton></li>
    ...
    <div class="card-footer" style="background-color:#124792">
      <small class="text-muted">
          <small class="text-light"><marquee> BCS LEARNING REQUIREDS</marquee></small>
...
<div class="card" style="box-shadow: rgba(0, 0, 0, 0.2) 0px 20px 30px;">
    ...
    <div class="card-footer" style="background-color:#124792">
      <small class="text-light"><marquee>BHM LEARNING REQUIREDS</marquee></small>
    </div>
  </div>
