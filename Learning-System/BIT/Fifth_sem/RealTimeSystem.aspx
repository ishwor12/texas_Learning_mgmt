<%@ Page Title="" Language="C#" MasterPageFile="~/BIT/bit.Master" AutoEventWireup="true" CodeBehind="RealTimeSystem.aspx.cs" Inherits="Learning_System.BIT.Fifth_sem.RealTimeSystem" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container">
         <h3>REAL TIME SYSTEM LEARNING RESOURCES</h3>
        <hr />
